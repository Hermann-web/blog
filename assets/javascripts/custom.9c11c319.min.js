      ...
      ((R = 150),
        ...
        (X.isMatch = n =
          function (h, b, S) {
            ...
            for (T = -1, y = -1; ++y < _; ) {
              for (
                F = b.charCodeAt(y), U = S.charCodeAt(y);
                ++T < g && ((M = h.charCodeAt(T)), !(M === F || M === U));
  ...
  var er = (function (e) {
    ...
    return (
      ...
      (r.prototype.requestAsyncId = function (t, o, n) {
        return (
          n === void 0 && (n = 0),
          Ve.setInterval(t.flush.bind(t, this), n)
        );
      }),
      ...
      (r.prototype._execute = function (t, o) {
        ...
        try {
          ...
          ((n = !0),
            (i = f || new Error("Scheduled action threw falsy error")));
        }
    ...
    return Se(
      () => (
        ...
        N(
          D(r, "load"),
          D(r, "error").pipe(
            Q(() => kr(() => new ReferenceError(`Invalid script: ${e}`))),
          ),
        ).pipe(
          P(() => {}),
    ...
    return (
      r.subscribe((n) => {
        ...
        (i.appendChild(
          ...
          (o.innerText = `$ ${n.total.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",")} a month`));
      }),
